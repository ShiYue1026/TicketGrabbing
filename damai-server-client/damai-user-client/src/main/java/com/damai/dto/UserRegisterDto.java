...
public class UserRegisterDto implements Serializable {
    ...
    @Schema(name ="confirmPassword", type ="String", description ="二次确认的密码",requiredMode= Schema.RequiredMode.REQUIRED)
    @NotBlank
    ...
    @Schema(name ="id", type ="captchaId", description ="captchaId 调用是否需要校验验证码接口返回",requiredMode= Schema.RequiredMode.REQUIRED)
    @NotBlank
