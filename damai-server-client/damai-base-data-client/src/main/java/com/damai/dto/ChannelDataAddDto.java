...
public class ChannelDataAddDto {
    ...
    @Schema(name ="name", type ="String", description ="名称",requiredMode= Schema.RequiredMode.REQUIRED)
    @NotBlank
    private String name;
    ...
    @Schema(name ="signPublicKey", type ="String", description ="rsa签名公钥", requiredMode= Schema.RequiredMode.REQUIRED)
    @NotBlank
    private String signPublicKey;

    @Schema(name ="signSecretKey", type ="String", description ="rsa签名私钥", requiredMode= Schema.RequiredMode.REQUIRED)
    @NotBlank
    ...
    @Schema(name ="tokenSecret", type ="String", description ="token秘钥", requiredMode= Schema.RequiredMode.REQUIRED)
    @NotBlank
